...
const story = {
    part1: {
        ...
        wrongChoice: `I helped you avenge Dizzy, I didnt agree to do anything else` ,
        rightChoice: `Sure! Let's go`,
        wrongResult:  `“Fine,” she says and you go your separate ways. You continue to perform good deeds, but songs are never written about you. You kill bad guys and help good people, but no one knows your name.  You lead a life of purpose and anonymity. Due to this, and your humble nature, you die alone and penniless at an old age. The world will never know the deeds you did and no one remembers you.`,
    ...
    part2: {
        ...
        wrongResult: `You step up to the guards as if you're going to chat with them and quickly pull your sword and stab the first guard, then the second guard comes at you, but the Princess takes him before he gets to you. You're quickly surrounded by guards and captured. You spend your days awaiting execution for your crimes. Finally, the day has come for you to die. You're escorted by the guards to the chopping block. You lay your head down and wonder how many people have died the way you are about to? Just before the ax comes down to sever your head from your body, you think, why did I kill all those people with so many witnesses?`,
        death: `You die!`
        // img: ' ',
        // img2: ' '
    },
    part3: {
        ...
        description: `“Actually sir, this is Princess Katy of Dizzylot and I am with her.  We come to claim her position as next in line for the throne” you say. “Oh well why didn’t you just say so, Princess Katy?” The gates open and you're allowed into the castle.  The castle is magnificent, the most beautiful place you've ever seen. You're in the great hall with gold and white pillars from floor to ceiling, arches resembling those of a church. At the end of the hall sits King Gary on a white marble throne. You approach cautiously.  “I have returned to reclaim my throne, Dizzy chose me as Dizzylot’s next ruler. You can leave your post as King regent.” finishes Princess Katy. “But you have been gone so long Princess, you should wait to adjust back into royal life. It looks like you have been through a lot” says King Gary. No, I don't need to adjust. I left only to bring Dizzy’s murderer to justice and now that I have completed my mission, I will take my place as rightful Queen of Dizzylot.” 
        “Well, well, left to avenge Dizzy huh?” says Gary, “the King”.  You sense the mood of the whole room shift.  “Well I guess you shouldn't have come back yet” says Gary.  “What are you saying?” asks Katy.  With thunderous laughter, Gary says “I ordered Dizzy’s death. I am the reason your precious dog is dead.”  “WHAT,” she says enraged. Without thinking, she lunges at Gary with her dagger but misses. In a moment Gary has disabled her weapon and knocked her aside.`,
        // img: $('body').css('background-image', 'url("imgs/deathscreen.
        question: `It's your turn, you come at the Gary remembering what a different, wise King once said to you….`,
        wrongChoice: 'wrong riddle',
        rightChoice: 'right riddle',
        wrongResult: `Gary easily brushes you aside and casts a spell of death grip. You feel life being sucked out of your body. Your hands wither, your hair grays, and you die a slow and painful death.`,
        death: `You die!`,
        rightResult:  `Your blade strikes through the heart of Gary, the battle is over. You see the Queen as she begins to wake. She sees that you have killed evil Gary.`,

        endStory: `The coming days go by in a blur as Queen Katy makes arrangements and does her best to undo all the damage evil "King" Gary had done on the kingdom. You are knighted and appointed the chief role guard to the Queen. The Queen and her guard go down in history as one of the most powerful and fair monarchs in all the realm. From time to time you see a small white dog watching from the distance, Dizzy telling you from another world that you have done well!`
    }
};
