...
const story = {
    part1: {
        ...
        wrongChoice: `No`,
        rightChoice: `Yes`,
        wrongResult: `You make your way down the path, but slip on all the blood and fall. You don't even notice the blade sticking out of your chest until you try to get up and are pulled down. Once you feel the pain, it is impossible to notice anything else, the pain racks your body.  In your final moments, you think to yourself “I should have…followed the…Princess.”`,
        death: `You die!`
        //img: $('body').css('background-image', 'url("../../public/imgs/deathscreen.PNG")'),
    },
    part2: {
        description: `You follow the footprints into the woods.  The forest grows thick as you run deeper and deeper through it. At this point, almost no sunlight is breaking through the thick dense forest. You see a figure just barely in front of you. Wait, let me explain,” says the Princess. “You have one minute.” You reply. I left the royal life after the death of my dog Dizzy. He actually was the creator of my kingdom and closer to a god than a real dog, but he was old and weak and someone murdered him. He was my best friend and I left to find his murderer.  I joined this group of bandits and became their leader. Through their connections, I learned the name of Dizzy’s killer, who happens to have an assassin in the marshes.`,
